...
\textbf{Equipment:} 12-gauge shotgun, 6 12-gauge shells, leathers
\end{multicols}
\begin{multicols}{2}
\subsection{Wheelman}
...
\textbf{Equipment:} 9mm pistol, 10 9mm rounds, blackthumb's tools
\subsection{Scavenger}
\textbf{Primary stat:} Wit\\
\textbf{Secondary stat:} Brains\\
\textbf{Skills:} barter, navigation, scavenging\\
\textbf{Equipment:} crowbar, looking glass, cartographer's kit
\end{multicols}
\begin{multicols}{2}
\subsection{Longshot}
...
\textbf{Equipment:} sniper rifle, 4 .308 rounds
\subsection{Blackthumb}
\textbf{Primary stat:} Brains\\
\textbf{Secondary stat:} Wit\\
\textbf{Skills:} initiative, lore, repair\\
\textbf{Equipment:} blackthumb's tools, 
\end{multicols}
...
\equipment{Jerry can (full)}{50}{}{A fuel canister containing 4 gallons of
  gasoline.}
...
\equipment{Looking glass}{100}{}{}

\equipment{Cartographer's kit}{80}{}{}
