...
\equipment{Sniper rifle}{140}{\hspace{2ex} \textbf{Rounds:} 15 scrap each}{Ranged weapon, with range 500 feet and maximum damage of 30. The attacking skill is \stat{Brains (Perception)} and \stat{Brains (Ranged weapons)} combined.}

\equipment{12-gauge shotgun}{80}{\hspace{2ex} \textbf{Rounds:} 10 scrap each}{Ranged weapon, with range 30 feet and maximum damage 20. You target all combatants in a 3-foot radius; each combatant makes a separate defending roll.}

\equipment{9mm pistol}{50}{\hspace{2ex} \textbf{Rounds:} 5 scrap each}{Ranged weapon, with range 150 feet and maximum damage 15.}
...
\equipment{Jerry can}{10}{\hspace{2ex} \textbf{To fill:} 50 scrap}{A fuel canister that can contain 4 gallons of gasoline.}
...
\manoeuvre{Accelerate}{2}{1}{Roll \die{2d8} + ACC/2. At the end of the tick, add the result to your Speed.} \manoeuvre{Maintain speed}{1}{1}{}
