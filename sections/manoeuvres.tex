...
\begin{abstractsection}{Collisions}
  When your vehicle collides with an obstacle, roll \stat{Speed} versus a single \die{d12}. If you ``succeed'', your vehicle takes damage equal to the difference. Your \stat{Speed} drops to 0. A collision has \duration{5} cooldown, and you can't man\oe{}uvre this tick.
\end{abstractsection}
