...
\begin{describe}{Engine fire}
  \prop{Difficulty}{+5}
  Subtract 5 from the vehicle's \stat{Acceleration} and \stat{Speed}. If the affliction isn't removed by the end of the setpiece, the vehicle explodes, and any occupants are presumed dead.
\end{describe}
