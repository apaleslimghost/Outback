...
\begin{describe}{Anti-boarder spikes}
  \prop{Cost}{60 scrap}
  Spikes adorning your vehicle's pillars. If a character tries to board your vehicle, your \stat{Handling} increases by \textbf{2} for the defence roll. If they fail, they take damage equal to the difference between the rolls.
\end{describe}
