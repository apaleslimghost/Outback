...
As the last action in a setpiece, drivers should roll to avoid the hazard, usually \stat{Handling} against the hazard's difficulty roll. If the roll fails or the driver doesn't take the action, the hazard has consequences for the vehicle.
