...
\textbf{Array:} assign \textbf{+4}, \textbf{0}, and \textbf{-3} to your stats

To calculate your \emph{maximum hit points}, look up your \stat{Brawn} on the Static Rolls table and add \textbf{12} to the result. If your \stat{Brawn} increases, your maximum hit points increasesa. Finally, starting with \textbf{300} scrap, buy equipment from the list.
