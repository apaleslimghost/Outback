...
To find your \emph{maximum hit points}, look up your \stat{\statPhysical} on the Static Rolls table and add \textbf{12} to the result. If your \stat{\statPhysical} increases, your max HP increases. Finally, starting with \textbf{160} scrap, buy equipment from the list.
