...
When conceiving your character, think about how they would answer the following questions. Either pick one from the lists, or come up with your own answers.

{\footnotesize
\begin{tabular}{$L{0.209\linewidth}^L{0.32\linewidth}^L{0.32\linewidth}}
\rowstyle{\bfseries}
...
To find your \emph{maximum hit points}, look up your \stat{Brawn} on the Static Rolls table and add \textbf{12} to the result. If your \stat{Brawn} increases, your max HP increases. Finally, starting with \textbf{300} scrap, buy equipment from the list.
