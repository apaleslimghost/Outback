...
\begin{describe}{Spyglass}
  \prop{Cost}{100 scrap}
  You can use the spyglass to see long distances. Using the glass to survey increases your \stat{Brains} by 1 for that roll.
\end{describe}

\begin{describe}{Cartographer's kit}
  \prop{Cost}{80 scrap}
  Using this kit, you can create a map of the vicinity. This takes 30 minutes. Using the map to navigate increases your \stat{Brains} by 1 for that roll.
\end{describe}

\begin{describe}{History relic}
  \prop{Cost}{priceless}
  An old book, a handful of photos, a child's doll, etc.. Once in each combat, you can describe how the relic lets you cling to your long-forgotten past. Your \stat{Wit} increases by 1 until the end of the setpiece.
\end{describe}

\begin{describe}{Chrome spray}
  \prop{Cost}{20 scrap}
  Single-use spray. Your \stat{Brawn} increases by 1 until the end of the setpiece.
\end{describe}
...
\begin{describe}{Leathers}
  \prop{Cost}{80 scrap}
  While wearing the leathers, your \stat{Wit} increases by 1 for defense rolls against unarmed attacks.
\end{describe}

\begin{describe}{Riot armour}
  \prop{Cost}{120 scrap}
  While wearing the armour, your \stat{Wit} increases by 1 for defense rolls against ranged weapon attacks.
\end{describe}
