...
\begin{describe}{Spyglass}
  \prop{Cost}{100 scrap}
  You can use the spyglass to see long distances. While using it, your \stat{Brains} increases by 1.
\end{describe}
...
\begin{describe}{History relic}
  \prop{Cost}{priceless}
  An old book, a handful of photos, a child's doll, etc.. Once per combat, you can describe how the relic lets you cling to your long-forgotten past. Your \stat{Wit} increases by 1 until the end of the setpiece.
\end{describe}
...
\begin{describe}{Polycarb spaulders}
  \prop{Cost}{60 scrap}
  While wearing the spaulders, your \stat{Brawn} increases by 1.
\end{describe}

\begin{describe}{Leathers}
  \prop{Cost}{80 scrap}
  While wearing leathers, your \stat{Brawn} increases by 2, but your \stat{Wit} decreases by 1.
\end{describe}
