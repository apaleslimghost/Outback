...
\begin{describe}{Shiv}
  \prop{Cost}{5 scrap}
  \prop{Attack cooldown}{\duration{1}}
...
\begin{describe}{Sniper rifle}
  ...
  \prop{Attack cooldown}{\duration{8}}
...
\begin{describe}{9mm pistol}
  ...
  \prop{Attack cooldown}{\duration{3}}
