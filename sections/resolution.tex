...
Your character can do something in one of three ways. You can act forcefully with your \stat{Brawn}. You can think about it and use your \stat{Brains}. Or you could be quick on your feet or tongue with your \stat{Wit}. These are your character's three \emph{stats}, which run from \textbf{-6} to \textbf{+6}.
...
Each of you rolls a \die{d12} and add the stat. The opponent stops there, but if your roll plus stat is 12 or more, mark down a ``12'', and roll again. Keep rolling until the score is than 12, then add all your twelves and your final roll together to get your total.
