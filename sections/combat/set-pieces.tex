...
Time in combat is broken down into \emph{setpieces}, which consist of 24 \emph{ticks}. At the start of a setpiece, each character rolls a single \die{d12}, adding their \stat{\statSkill} plus 6. That's their \emph{starting tick}.
