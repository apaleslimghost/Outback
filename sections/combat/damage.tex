...
To restore HP, roll a \die{d8} and add your \stat[Repair]{Brains} modifier. Add the result to the target's HP. Note that if your modifier is negative, you might end up doing damage instead! To remove an affliction, roll \stat[Repair]{Brains} versus its \stat{Difficulty}. If you succeed, the affliction is removed. Both these actions have \duration{8} cooldown.
\end{abstractsection}
